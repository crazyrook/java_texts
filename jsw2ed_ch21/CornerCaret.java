...
public class CornerCaret extends DefaultCaret{
	...
	protected synchronized void damage(Rectangle r){
		if(r==null)return;
		//Give values to x,y,width,height (inherited from java.awt.Rectangel).
		x = r.x;
	...
	public void paint(Graphics g){
		...
		if( (x != r.x) || (y != r.y + dist) ){
			// paint() has been called directyly, without a previous call to
			// damage(), so do some cleanup. (This happnes, for example, when the
